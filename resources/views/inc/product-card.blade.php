<a  class="text-muted lead" :href="'/compare/'+product.slug+'/prices'">
    <div class="card w-100 b-0" >
        ...
        @endif
        <img v-else src="https://via.placeholder.com/200x150" class="card-img-top" alt="no-image">
        <div class="card-body">
            <h6 class="lead"> <small>@{{product.title.substring(0,140)+".."}}</small> </h6>
